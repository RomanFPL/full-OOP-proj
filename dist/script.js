...
/* harmony import */ var _modules_diff__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/diff */ "./src/js/modules/diff.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  player.init();
  new _modules_diff__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item').init();
});

/***/ }),

/***/ "./src/js/modules/diff.js":
/*!********************************!*\
  !*** ./src/js/modules/diff.js ***!
  \********************************/
...
/*#__PURE__*/
function () {
  function Diff(oldOfficer, newOfficer, items) {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindCloseBtn() {
      ...
      this.close.addEventListener('click', function () {
        ...
        _this2.player.stopVideo(); // this.player.pauseVideo();
    ...
    value: function showSlides(n) {
      ...
      try {
        ...
        if (n === 3) {
          ...
          this.hanson.classList.add('classInUp');
        }
      } catch (e) {
        console.log(e);
      }
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function nextSlide() {
      if (this.slides[1].tagName == "BUTTON" && this.slides[0].tagName == "BUTTON") {
